...
lx_borg_backup_zstd() {
  ...
  # 2026-06-11 jj5 - NEW: gonna try this...
  args+=( --compression auto,zstd,3 );
  # 2026-05-04 jj5 - OLD: use stronger compression...
  #args+=( --compression zstd,18 );
  # 2026-01-28 jj5 - OLD: removed threads=auto because my version of borg does not support
